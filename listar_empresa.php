  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class="listar-empresa">
        <a href="listar_empresa.php" class="nav-link active">
...
$empresas_query = "SELECT * FROM cadastro_empresas";
$result_empresas = mysqli_query($conn, $empresas_query);

// Cria a tabela HTML para exibir as empresas
echo '<table class="table">';
echo '<thead><tr><th>Nome</th><th>Endereço</th><th>Telefone</th><th>CNPJ</th></tr></thead>';
echo '<tbody>';
