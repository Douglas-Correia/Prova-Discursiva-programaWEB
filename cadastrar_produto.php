...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="cadastrar_empresa.php" class="nav-link text-white" aria-current="page">
      ...
      <li>
        <a href="cadastrar_produto.php" class="nav-link active">
...
<form action="form_cad_produto.php" method="post">
  <div class="row">
    <div class="col-md-5">
      <div class="form-group">
        <label for="nome">Nome do Produto:</label>
        <input type="text" class="form-control" id="nome" name="nome-produto">
      </div>
    </div>
    <div class="col-md-5">
      <div class="form-group">
        <label for="endereco">Quantidade:</label>
        <input type="number" class="form-control" id="endereco" name="quantidade">
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-5">
      <div class="form-group">
        ...
        <input type="date" class="form-control" id="telefone" name="data-entrada">
      </div>
    </div>
    <div class="col-md-5">
      <div class="form-group">
        <label for="email">Valor:</label>
        <input type="number" class="form-control" id="email" name="valor">
      </div>
    </div>
    <div class="col-md-5">
      <div class="form-group">
  ...
  <!-- adicione mais campos aqui, se necessário -->
    <div class="col-md-2">
        <button type="submit" class="btn btn-primary control-form" name="cad-produto">Cadastrar</button>
    </div>
</div>
</form>
