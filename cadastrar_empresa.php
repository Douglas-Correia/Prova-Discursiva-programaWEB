...
<html lang="pt-br" data-bs-theme="auto">
  <head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <link href="style-painel.css" rel="stylesheet">
  </head>
  <body>
...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="cadastrar_empresa.php" class="nav-link active" aria-current="page">
      ...
      <li>
        <a href="cadastrar_produto.php" class="nav-link text-white">
      ...
      <li>
        <a href="listar_produtos.php" class="nav-link text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
        <path d="M9.5 0a.5.5 0 0 1 .5.5.5.5 0 0 0 .5.5.5.5 0 0 1 .5.5V2a.5.5 0 0 1-.5.5h-5A.5.5 0 0 1 5 2v-.5a.5.5 0 0 1 .5-.5.5.5 0 0 0 .5-.5.5.5 0 0 1 .5-.5h3Z"/>
        <path d="M3 2.5a.5.5 0 0 1 .5-.5H4a.5.5 0 0 0 0-1h-.5A1.5 1.5 0 0 0 2 2.5v12A1.5 1.5 0 0 0 3.5 16h9a1.5 1.5 0 0 0 1.5-1.5v-12A1.5 1.5 0 0 0 12.5 1H12a.5.5 0 0 0 0 1h.5a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-12Z"/>
        <path d="M10.854 7.854a.5.5 0 0 0-.708-.708L7.5 9.793 6.354 8.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3Z"/>
      ...
      <li>
        <a href="melhores_preços.php" class="nav-link text-white">
...
<form action="form_cad_empresa.php" method="post">
  <div class="row">
    <div class="col-md-5">
      <div class="form-group">
        <label for="nome">CNPJ:</label>
        <input type="text" class="form-control" id="nome" name="cnpj" require>
      </div>
    </div>
    <div class="col-md-5">
      <div class="form-group">
        <label for="endereco">Nome da empresa:</label>
        <input type="text" class="form-control" id="endereco" name="nome_empresa" require>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-5">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="telefone" name="endereco" require>
      </div>
    </div>
    <div class="col-md-5">
      <div class="form-group">
        <label for="">Telefone:</label>
        <input type="text" class="form-control" id="cnpj" name="telefone" require>
      </div>
    </div>
  </div>
  <!-- adicione mais campos aqui, se necessário -->
    <div class="col-md-2">
        <button type="submit" class="btn btn-primary control-form" name="cad-empresa">Cadastrar</button>
    </div>
</div>
</form>
